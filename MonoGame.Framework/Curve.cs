...
{
    /// <summary>
    /// Contains a collection of <see cref="CurveKey"/> points in 2D space and provides methods for evaluating features
    /// of the curve they define.
    /// </summary>
...
/// </summary>
        [DataMember]
        public bool IsConstant { get { return this._keys.Count <= 1; } }

        /// <summary>
        /// Defines how to handle weighting values that are less than the first control point in the curve.
        /// </summary>
        [DataMember]
        public CurveLoopType PreLoop { get { return this._preLoop; } set { this._preLoop = value; } }

        /// <summary>
        /// Defines how to handle weighting values that are greater than the last control point in the curve.
        /// </summary>
        [DataMember]
        public CurveLoopType PostLoop { get { return this._postLoop; } set { this._postLoop = value; } }
...
/// Constructs a curve.
/// </summary>
        public Curve() { this._keys = new CurveKeyCollection(); }
