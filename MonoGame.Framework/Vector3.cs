...
/// </summary>
        ...
        {
            get { return string.Concat(this.X.ToString(), "  ", this.Y.ToString(), "  ", this.Z.ToString()); }
        }
...
/// </summary>
        ...
        public static void Barycentric(ref Vector3 value1,
                                       ref Vector3 value2,
                                       ref Vector3 value3,
                                       float amount1,
                                       float amount2,
        ...
        public static void CatmullRom(ref Vector3 value1,
                                      ref Vector3 value2,
                                      ref Vector3 value3,
                                      ref Vector3 value4,
                                      float amount,
        ...
        public static void Hermite(ref Vector3 value1,
        ...
        /// <summary>
        /// Creates a new <see cref="Vector3"/> that contains linear interpolation of the specified vectors. Uses <see
        /// cref="MathHelper.LerpPrecise"/> on MathHelper for the interpolation. Less efficient but more precise
        /// compared to <see cref="Vector3.Lerp(Vector3, Vector3, float)"/>. See remarks section of <see
        /// cref="MathHelper.LerpPrecise"/> on MathHelper for more info.
        /// </summary>
        /// <param name="value1">The first vector.</param>
        /// <param name="value2">The second vector.</param>
        /// <param name="amount">Weighting value(between 0.0 and 1.0).</param>
        ...
        {
            return new Vector3(MathHelper.LerpPrecise(value1.X, value2.X, amount),
        ...
        /// Creates a new <see cref="Vector3"/> that contains linear interpolation of the specified vectors. Uses <see
        /// cref="MathHelper.LerpPrecise"/> on MathHelper for the interpolation. Less efficient but more precise
        /// compared to <see cref="Vector3.Lerp(ref Vector3, ref Vector3, float, out Vector3)"/>. See remarks section of
        ...
        {
            return new Vector3(MathHelper.Max(value1.X, value2.X),
        ...
        {
            return new Vector3(MathHelper.Min(value1.X, value2.X),
        ...
        /// <summary>
        /// Returns a <see cref="String"/> representation of this <see cref="Vector3"/> in the format: {X:[<see
        /// cref="X"/>] Y:[<see cref="Y"/>] Z:[<see cref="Z"/>]}
        /// </summary>
        ...
        /// <summary>
/// Creates a new <see cref="Vector3"/> that contains a transformation of 3d-vector by the specified <see
/// cref="Matrix"/>.
/// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="Vector3"/> that contains a transformation of 3d-vector by the specified <see
        /// cref="Quaternion"/>, representing the rotation.
        /// </summary>
        /// <param name="value">Source <see cref="Vector3"/>.</param>
                                     ...
                                     int length)
        {
            ...
            for(var i = 0; i < length; i++)
            {
                ...
                destinationArray[destinationIndex + i] =
                    new Vector3((position.X * matrix.M11) +
        ...
        /// <summary>
        /// Apply transformation on vectors within array of <see cref="Vector3"/> by the specified <see
        ...
        /// <summary>
        /// Apply transformation on all vectors within array of <see cref="Vector3"/> by the specified <see
...
/// </summary>
                                           ...
                                           int length)
        {
            ...
            for(int x = 0; x < length; x++)
            {
                ...
                destinationArray[destinationIndex + x] =
                     new Vector3((normal.X * matrix.M11) + (normal.Y * matrix.M21) + (normal.Z * matrix.M31),
        ...
        /// <summary>
        /// Apply transformation on all normals within array of <see cref="Vector3"/> by the specified <see
        /// cref="Matrix"/> and places the results in an another array.
        /// </summary>
        /// <param name="sourceArray">Source array.</param>
        /// <param name="matrix">The transformation <see cref="Matrix"/>.</param>
