...
/// </summary>
        ...
        /// <summary>
        /// Raises the AsyncRunLoopEnded event.  This method must be called by derived classes when the asynchronous run
        /// loop they start has stopped running.
        /// </summary>
        protected void RaiseAsyncRunLoopEnded() { EventHelpers.Raise(this, AsyncRunLoopEnded, EventArgs.Empty); }
        ...
        /// <summary>
/// Gives derived classes an opportunity to do work before any components are initialized.  Note that the base
/// implementation sets IsActive to true, so derived classes should either call the base implementation or set
/// IsActive to true by their own means.
/// </summary>
        public virtual void BeforeInitialize() { IsActive = true; }

        /// <summary>
        /// Gives derived classes an opportunity to do work just before the run loop is begun.  Implementations may also
        /// return false to prevent the run loop from starting.
        /// </summary>
        /// <returns></returns>
        public virtual bool BeforeRun() { return true; }
        ...
        /// <summary>
        /// Gives derived classes an opportunity to do work just before Update is called for all IUpdatable components. 
        ...
        /// <summary>
        /// Gives derived classes an opportunity to do work just before Draw is called for all IDrawable components. 
        ...
        public virtual TimeSpan TargetElapsedTimeChanging(TimeSpan value) { return value; }
        ...
        /// <summary>
        /// MSDN: Use this method if your game is recovering from a slow-running state, and ElapsedGameTime is too large
        /// to be useful. Frame timing is generally handled by the Game class, but some platforms still handle it
        /// elsewhere. Once all platforms rely on the Game class's functionality, this method and any overrides should
        /// be removed.
        /// </summary>
