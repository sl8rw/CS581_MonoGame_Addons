...
namespace Microsoft.Xna.Framework.Media
{
    public static partial class MediaPlayer
    {
        ...
        static MediaPlayer() { PlatformInitialize(); }

        #region Properties

        public static MediaQueue Queue { get { return _queue; } }

        public static bool IsMuted { get { return PlatformGetIsMuted(); } set { PlatformSetIsMuted(value); } }
        ...
        public static bool IsShuffled { get { return PlatformGetIsShuffled(); } set { PlatformSetIsShuffled(value); } }
        ...
        public static bool GameHasControl { get { return PlatformGetGameHasControl(); } }
        ...
        /// <summary>
        /// Play clears the current playback queue, and then queues up the specified song for playback.  Playback starts
        /// immediately at the beginning of the song.
        /// </summary>
        public static void Play(Song song) { Play(song, null); }

        /// <summary>
        /// Play clears the current playback queue, and then queues up the specified song for playback.  Playback starts
        /// immediately at the given position of the song.
        /// </summary>
