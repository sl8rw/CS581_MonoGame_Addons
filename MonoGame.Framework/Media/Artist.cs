...
namespace Microsoft.Xna.Framework.Media
{
    public sealed class Artist : IDisposable
    {
        ...
        /// </summary>
        public string Name { get { return this.artist; } }
        ...
        public Artist(string artist) { this.artist = artist; }
        ...
        /// </summary>
        public override string ToString() { return this.artist.ToString(); }

        /// <summary>
        /// Gets the hash code for this instance.
        /// </summary>
        public override int GetHashCode() { return this.artist.GetHashCode(); }
    }
}
