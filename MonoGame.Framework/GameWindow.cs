...
namespace Microsoft.Xna.Framework
{
    public abstract class GameWindow
    {
        ...
        /// <summary>
        /// Gets or sets a bool that enables usage of Alt+F4 for window closing on desktop platforms. Value is true by
        /// default.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// For Windows 8 and Windows 10 UWP this has no effect. For these platforms the title should be set by using
        /// the DisplayName property found in the app manifest file.
        /// </remarks>
        public string Title
        {
            get { return _title; }
        ...
        /// <summary>
        /// Determines whether the border of the window is visible. Currently only supported on the WinDX and
        /// WinGL/Linux platforms.
        /// </summary>
        ...
        /// <summary>
/// Use this event to retrieve text for objects like textbox's. This event is not raised by noncharacter keys.
/// This event also supports key repeat. For more information this event is based off:
...
#if WINDOWS || WINDOWS_UAP || DESKTOPGL || ANGLE
        internal void OnTextInput(TextInputEventArgs e) { EventHelpers.Raise(this, TextInput, e); }
        internal void OnKeyDown(InputKeyEventArgs e) { EventHelpers.Raise(this, KeyDown, e); }
        internal void OnKeyUp(InputKeyEventArgs e) { EventHelpers.Raise(this, KeyUp, e); }
#endif
