...
namespace Microsoft.Xna.Framework.Graphics
{
    public partial class TextureCube : Texture
    {
        ...
        public TextureCube(GraphicsDevice graphicsDevice, int size, bool mipMap, SurfaceFormat format) : this(graphicsDevice,
                                                                                                              size,
                                                                                                              mipMap,
                                                                                                              format,
                                                                                                              false)
        ...
        internal TextureCube(GraphicsDevice graphicsDevice,
                             int size,
                             bool mipMap,
        ...
        public void GetData<T>(CubeMapFace cubeMapFace,
                               int level,
                               Rectangle? rect,
                               T[] data,
                               int startIndex,
            ...
            where T : struct
        {
            ...
            if(Format.IsCompressedFormat())
            {
                ...
                checkedRect = new Rectangle(checkedRect.X & ~0x3,
                                            checkedRect.Y & ~0x3,
#if OPENGL
                    ...
                    checkedRect.Width < 4 && textureBounds.Width < 4 ? textureBounds.Width : roundedWidth,
                                            checkedRect.Height < 4 && textureBounds.Height < 4
