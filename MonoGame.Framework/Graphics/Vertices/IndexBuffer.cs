...
namespace Microsoft.Xna.Framework.Graphics
{
    public partial class IndexBuffer : GraphicsResource
    {
        ...
        protected IndexBuffer(GraphicsDevice graphicsDevice,
                              ...
                              int indexCount,
                              BufferUsage usage,
                              bool dynamic) : this(graphicsDevice,
        ...
        public IndexBuffer(GraphicsDevice graphicsDevice, Type indexType, int indexCount, BufferUsage usage) : this(graphicsDevice,
                                                                                                                    SizeForType(graphicsDevice,
                                                                                                                                indexType),
                                                                                                                    indexCount,
                                                                                                                    usage,
                                                                                                                    false)
        ...
        public void GetData<T>(T[] data) where T : struct { this.GetData<T>(0, data, 0, data.Length); }
