...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    /// </summary>
    /// <remarks>
    /// In the DirectX version the input layouts are cached in a dictionary. The <see cref="VertexInputLayout"/> is used
    /// as the key in the dictionary and therefore needs to implement <see cref="IEquatable{T}"/>. Two <see
    /// cref="VertexInputLayout"/> instance are considered equal if the vertex layouts are structurally identical.
    /// </remarks>
    internal abstract partial class VertexInputLayout : IEquatable<VertexInputLayout>
    {
        ...
        protected VertexInputLayout(int maxVertexBufferSlots) : this(new VertexDeclaration[maxVertexBufferSlots],
        ...
        /// langword="false"/>.
        /// </returns>
        public override bool Equals(object obj) { return Equals(obj as VertexInputLayout); }

        /// <summary>
        /// Determines whether the specified <see cref="VertexInputLayout"/> is equal to this instance.
        /// </summary>
        /// <param name="other">The object to compare with the current object.</param>
        /// <returns>
        /// <see langword="true"/> if the specified <see cref="VertexInputLayout"/> is equal to this instance;
