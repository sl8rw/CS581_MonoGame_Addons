...
namespace Microsoft.Xna.Framework.Graphics
{
    public partial class VertexBuffer : GraphicsResource
    {
        ...
        public VertexBuffer(GraphicsDevice graphicsDevice,
                            VertexDeclaration vertexDeclaration,
                            int vertexCount,
                            BufferUsage bufferUsage) : this(graphicsDevice,
                                                            vertexDeclaration,
                                                            vertexCount,
                                                            bufferUsage,
                                                            false)
        ...
        public VertexBuffer(GraphicsDevice graphicsDevice, Type type, int vertexCount, BufferUsage bufferUsage) : this(graphicsDevice,
        ...
        ///
        /// <remarks>
        /// Note that this pulls data from VRAM into main memory and because of that is a very expensive operation. It
        /// is often a better idea to keep a copy of the data in main memory.
        /// </remarks>
        ///
        /// <remarks>
        ...
        /// </remarks>
        public void GetData<T>(int offsetInBytes, T[] data, int startIndex, int elementCount, int vertexStride = 0)
            where T : struct
        {
        ...
        /// <summary>
        /// Sets the vertex buffer data, specifying the index at which to start copying from the source data array, the
        /// number of elements to copy from the source data array,  and how far apart elements from the source data
        /// array should be when they are copied into the vertex buffer.
        /// </summary>
        ...
        /// Index at which to start copying from <paramref name="data"/>. Must be within the <paramref name="data"/>
        /// array bounds.
        /// </param>
        /// <param name="elementCount">
        /// Number of elements to copy from <paramref name="data"/>. The combination of <paramref name="startIndex"/>
        /// and <paramref name="elementCount"/>  must be within the <paramref name="data"/> array bounds.
        /// </param>
        /// <param name="vertexStride">
        /// Specifies how far apart, in bytes, elements from <paramref name="data"/> should be when  they are copied
        /// into the vertex buffer. In almost all cases this should be <c>sizeof(T)</c>, to create a tightly-packed
        /// vertex buffer. If you specify <c>sizeof(T)</c>, elements from <paramref name="data"/> will be copied into
        /// the  vertex buffer with no padding between each element. If you specify a value greater than
        /// <c>sizeof(T)</c>, elements from <paramref name="data"/> will be copied  into the vertex buffer with padding
        /// between each element. If you specify <c>0</c> for this parameter, it will be treated as if you had specified
        /// <c>sizeof(T)</c>. With the exception of <c>0</c>, you must specify a value greater than or equal to
        /// <c>sizeof(T)</c>.
        /// </param>
        /// <remarks>
        ...
        /// Vector2[] texCoords = new Vector2[numVertices]; vertexBuffer.SetData(12, texCoords, 0, numVertices,
        /// vertexBuffer.VertexDeclaration.VertexStride);</code>
        /// </remarks>
        /// <remarks>
        ...
        /// <summary>
        /// Sets the vertex buffer data, specifying the index at which to start copying from the source data array, and
        /// the number of elements to copy from the source data array. This is the same as calling  <see
        /// cref="SetData{T}(int, T[], int, int, int)"/>  with <c>offsetInBytes</c> equal to <c>0</c>, and
        /// <c>vertexStride</c> equal to <c>sizeof(T)</c>.
        /// </summary>
        /// <typeparam name="T">Type of elements in the data array.</typeparam>
        /// <param name="data">Data array.</param>
        /// <param name="startIndex">
        ...
        /// with <c>offsetInBytes</c> and <c>startIndex</c> equal to <c>0</c>, <c>elementCount</c> equal to
        /// <c>data.Length</c>,  and <c>vertexStride</c> equal to <c>sizeof(T)</c>.
        /// </summary>
        /// <typeparam name="T">Type of elements in the data array.</typeparam>
        /// <param name="data">Data array.</param>
            ...
            where T : struct
        {
            ...
            PlatformSetDataInternal<T>(offsetInBytes,
                                       data,
                                       startIndex,
                                       elementCount,
                                       vertexStride,
