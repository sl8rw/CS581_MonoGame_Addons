...
namespace Microsoft.Xna.Framework.Graphics.PackedVector
{
    ...
    public struct Bgr565 : IPackedVector<UInt16>, IEquatable<Bgr565>, IPackedVector
    {
        ...
        public Bgr565(float x, float y, float z) { _packedValue = Pack(x, y, z); }

        /// <summary>
        /// Creates a new instance of Bgr565.
        /// </summary>
        /// <param name="vector">Vector containing the components for the packed vector.</param>
        public Bgr565(Vector3 vector) { _packedValue = Pack(vector.X, vector.Y, vector.Z); }
        ...
        public Vector4 ToVector4() { return new Vector4(ToVector3(), 1.0f); }
        ...
        public bool Equals(Bgr565 other) { return _packedValue == other._packedValue; }
