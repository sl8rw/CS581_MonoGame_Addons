...
{
    /// <summary>
    /// Packed vector type containing unsigned normalized values ranging from 0 to 1. The x, y and z components use 10
    /// bits, and the w component uses 2 bits.
    /// </summary>
    public struct Rgba1010102 : IPackedVector<uint>, IEquatable<Rgba1010102>, IPackedVector
    {
        ...
        public Rgba1010102(float x, float y, float z, float w) { packedValue = Pack(x, y, z, w); }
        ...
        /// </param>
        public Rgba1010102(Vector4 vector) { packedValue = Pack(vector.X, vector.Y, vector.Z, vector.W); }
...
(((packedValue >> 30) & 0x03) / 3.0f));
        ...
        public override bool Equals(object obj) { return (obj is Rgba1010102) && Equals((Rgba1010102)obj); }
        ...
        public bool Equals(Rgba1010102 other) { return packedValue == other.packedValue; }
        ...
        {
            return (uint)((((int)Math.Round(MathHelper.Clamp(x, 0, 1) * 1023.0f) & 0x03FF) << 0) |
