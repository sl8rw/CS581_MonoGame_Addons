...
{
    /// <summary>
    /// Packed vector type containing unsigned normalized values, ranging from 0 to 1, using 4 bits each for x, y, z,
    /// and w.
    /// </summary>
    public struct Bgra4444 : IPackedVector<UInt16>, IEquatable<Bgra4444>
    {
        ...
        public Bgra4444(float x, float y, float z, float w) { _packedValue = Pack(x, y, z, w); }

        /// <summary>
        /// Creates a new instance of Bgra4444.
        /// </summary>
        /// <param name="vector">Vector containing the components for the packed vector.</param>
        public Bgra4444(Vector4 vector) { _packedValue = Pack(vector.X, vector.Y, vector.Z, vector.W); }

        /// <summary>
        /// Gets and sets the packed value.
        /// </summary>
        [CLSCompliant(false)]
        public UInt16 PackedValue { get { return _packedValue; } set { _packedValue = value; } }
        ...
        public bool Equals(Bgra4444 other) { return _packedValue == other._packedValue; }
        ...
        public override int GetHashCode() { return _packedValue.GetHashCode(); }
