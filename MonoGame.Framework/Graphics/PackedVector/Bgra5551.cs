...
{
    /// <summary>
    /// Packed vector type containing unsigned normalized values ranging from 0 to 1. The x , y and z components use 5
    /// bits, and the w component uses 1 bit.
    /// </summary>
    public struct Bgra5551 : IPackedVector<UInt16>, IEquatable<Bgra5551>, IPackedVector
    {
        ...
        /// </summary>
        [CLSCompliant(false)]
        public UInt16 PackedValue { get { return packedValue; } set { packedValue = value; } }
        ...
        public Bgra5551(float x, float y, float z, float w) { packedValue = Pack(x, y, z, w); }
        ...
        /// </param>
        public Bgra5551(Vector4 vector) { packedValue = Pack(vector.X, vector.Y, vector.Z, vector.W); }
...
(float)((packedValue >> 15) & 0x01));
        ...
        public override bool Equals(object obj) { return (obj is Bgra5551) && Equals((Bgra5551)obj); }
        ...
        public bool Equals(Bgra5551 other) { return packedValue == other.packedValue; }
        ...
        {
            return (UInt16)((((int)Math.Round(MathHelper.Clamp(x, 0, 1) * 31.0f) & 0x1F) << 10) |
