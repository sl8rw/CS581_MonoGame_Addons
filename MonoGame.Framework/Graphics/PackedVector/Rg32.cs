...
namespace Microsoft.Xna.Framework.Graphics.PackedVector
{
    ...
    public struct Rg32 : IPackedVector<uint>, IEquatable<Rg32>, IPackedVector
    {
        ...
        public Rg32(float x, float y) { packedValue = Pack(x, y); }
        ...
        /// </param>
        public Rg32(Vector2 vector) { packedValue = Pack(vector.X, vector.Y); }
...
(((packedValue >> 16) & 0xFFFF) / 65535.0f));
        ...
        public override bool Equals(object obj) { return (obj is Rg32) && Equals((Rg32)obj); }
        ...
        public bool Equals(Rg32 other) { return packedValue == other.packedValue; }

        /// <summary>
        /// Gets a string representation of the packed vector.
        /// </summary>
        /// <returns>A string representation of the packed vector.</returns>
        public override string ToString() { return ToVector2().ToString(); }
        ...
        {
            return (uint)((((int)Math.Round(MathHelper.Clamp(x, 0, 1) * 65535.0f) & 0xFFFF)) |
