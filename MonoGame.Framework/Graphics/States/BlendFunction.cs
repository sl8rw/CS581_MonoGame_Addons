...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    public enum BlendFunction
    {
        ...
        ReverseSubtract,
        /// <summary>
        /// The function will extracts minimum of the source and destination. min((srcColor * srcBlend),(destColor *
        /// destBlend))
        /// </summary>
        Min,
        /// <summary>
        /// The function will extracts maximum of the source and destination. max((srcColor * srcBlend),(destColor *
        /// destBlend))
        /// </summary>
        Max
    }
