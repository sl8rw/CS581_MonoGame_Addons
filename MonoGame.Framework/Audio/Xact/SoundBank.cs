...
namespace Microsoft.Xna.Framework.Audio
{
    ...
    public class SoundBank : IDisposable
    {
        ...
        public SoundBank(AudioEngine audioEngine, string fileName)
        {
            ...
            using(var stream = AudioEngine.OpenStream(fileName, true))
                using(var reader = new BinaryReader(stream))
                {
                    ...
                    if(formatVersion != 43)
                        Debug.WriteLine($"Warning: SoundBank format {formatVersion} not supported.");
        ...
        /// <remarks>
        /// <para>Cue instances are unique, even when sharing the same name. This allows multiple instances to
        /// simultaneously play.</para>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Commonly used for short lived effects.  To dynamically change the 3D  positional information on a cue over
        /// time use <see cref="GetCue"/> and <see cref="Cue.Apply3D"/>.
        /// </remarks>
