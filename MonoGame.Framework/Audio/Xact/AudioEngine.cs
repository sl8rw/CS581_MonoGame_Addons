...
namespace Microsoft.Xna.Framework.Audio
{
    ...
    public class AudioEngine : IDisposable
    {
        ...
        public AudioEngine(string settingsFile) : this(settingsFile, TimeSpan.Zero, string.Empty) { }
        ...
        /// Determines how many milliseconds the engine will look ahead when determing when to transition to another
        /// sound.
        /// </param>
