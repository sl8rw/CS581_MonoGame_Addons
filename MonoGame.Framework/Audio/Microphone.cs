...
/// </summary>
        ...
        /// <summary>
        /// Gets or sets the capture buffer duration. This value must be greater than 100 milliseconds, lower than 1000
        /// milliseconds, and must be 10 milliseconds aligned (BufferDuration % 10 == 10).
        /// </summary>
...
#endif
        /// <summary>
        /// Determines if the microphone is a wired headset. Note: XNA could know if a headset microphone was plugged in
        /// an Xbox 360 controller but MonoGame can't. Hence, this is always true on mobile platforms, and always false
        /// otherwise.
        /// </summary>
        public bool IsHeadset { get { return _isHeadset; } }
...
/// </summary>
        ...
        public int GetData(byte[] buffer) { return GetData(buffer, 0, buffer.Length); }
        ...
        /// <returns>The buffer size, in bytes, of the captured data.</returns>
        public int GetData(byte[] buffer, int offset, int count) { return PlatformGetData(buffer, offset, count); }
