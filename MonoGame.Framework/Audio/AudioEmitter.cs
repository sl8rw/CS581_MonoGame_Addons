...
namespace Microsoft.Xna.Framework.Audio
{
    ...
    public class AudioEmitter
    {
        ...
        /// </summary>
        /// <remarks>
        /// <para>Defaults to 1.0</para> <para>A value of 1.0 leaves the Doppler effect unmodified.</para>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// <para>Defaults to Vector3.Forward. (new Vector3(0, 0, -1))</para> <para>Used with AudioListener.Velocity to
        /// calculate Doppler values.</para> <para>The Forward and Up values must be orthonormal.</para>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// <para>Defaults to Vector3.Up. (new Vector3(0, -1, 1)).</para> <para>The Up and Forward vectors must be
        /// orthonormal.</para>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// <para>Defaults to Vector3.Zero.</para> <para>This value is only used when calculating Doppler values.</para>
        /// </remarks>
