...
namespace MonoGame.Utilities.Deflate
{
    ...
    /// preset dictionary, and 15 window bits by default.</para> <para>This class is similar to <see
    /// cref="DeflateStream"/>, except that it adds the RFC1950 header and trailer bytes to a compressed stream when
    /// compressing, or expects the RFC1950 header and trailer bytes when decompressing.  It is also similar to the<see
    /// cref="GZipStream"/>.</para>
    /// </remarks>
