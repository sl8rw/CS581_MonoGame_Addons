...
namespace MonoGame.Utilities.Deflate
{
    ...
    public class DeflateStream : System.IO.Stream
    {
        ...
        ///
        /// <remarks>
        /// When mode is <c>CompressionMode.Compress</c>, the DeflateStream will use   the default compression level.
        /// The "captive" stream will be closed when   the DeflateStream is closed.
        /// </remarks>
        ///
        /// <example>
        ...
        /// <summary>
        /// Create a <c>DeflateStream</c> using the specified   <c>CompressionMode</c>, and explicitly specify whether
        ...
        /// <summary>
        /// Create a <c>DeflateStream</c> using the specified <c>CompressionMode</c>   and the specified
        ...
        /// can write additional data to the output stream here. End Using</code>
        /// </example>
        /// <param name="stream">The stream which will be read or written.</param>
        /// <param name="mode">Indicates whether the DeflateStream will compress or decompress.</param>
...
/// </remarks>
        ...
        ///
        /// <remarks>
        /// By tweaking this parameter, you may be able to optimize the compression for   data with particular
        /// characteristics.
        /// </remarks>
        ...
        /// been called by the runtime from inside the object finalizer and this method should not reference other
        /// objects; in that case only unmanaged resources must be referenced or disposed.</para>
        /// </remarks>
