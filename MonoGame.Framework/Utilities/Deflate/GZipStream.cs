...
namespace MonoGame.Utilities.Deflate
{
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        /// MonoGame.Utilities.Deflate.GZipStream(input, CompressionMode.Decompress, True) Using output As Stream =
        ...
        public GZipStream(Stream stream, CompressionMode mode, CompressionLevel level) : this(stream,
                                                                                              mode,
                                                                                              level,
                                                                                              false)
        { }
        ...
        /// </param>
        public GZipStream(Stream stream, CompressionMode mode, bool leaveOpen) : this(stream,
                                                                                      mode,
...
/// </param>
        ...
        /// !=0) { output.Write(working, 0, n); } } } }</code>
        /// </example>
