...
namespace Microsoft.Xna.Framework
{
    ...
    public class CurveKey : IEquatable<CurveKey>, IComparable<CurveKey>
    {
        ...
        /// <summary>
/// Gets or sets the indicator whether the segment between this point and the next point on the curve is
/// discrete or continuous.
/// </summary>
        [DataMember]
        public CurveContinuity Continuity { get { return this._continuity; } set { this._continuity = value; } }

        /// <summary>
        /// Gets a position of the key on the curve.
        /// </summary>
        [DataMember]
        public float Position { get { return this._position; } }

        /// <summary>
        /// Gets or sets a tangent when approaching this point from the previous point on the curve.
        /// </summary>
        [DataMember]
        public float TangentIn { get { return this._tangentIn; } set { this._tangentIn = value; } }

        /// <summary>
        /// Gets or sets a tangent when leaving this point to the next point on the curve.
        /// </summary>
        [DataMember]
        public float TangentOut { get { return this._tangentOut; } set { this._tangentOut = value; } }
...
/// </summary>
        ...
        public CurveKey(float position, float value) : this(position, value, 0, 0, CurveContinuity.Smooth) { }
        ...
        public CurveKey(float position, float value, float tangentIn, float tangentOut) : this(position,
                                                                                               value,
                                                                                               tangentIn,
                                                                                               tangentOut,
...
/// </summary>
        ...
        public int CompareTo(CurveKey other) { return this._position.CompareTo(other._position); }

        public bool Equals(CurveKey other) { return (this == other); }

        public override bool Equals(object obj) { return (obj as CurveKey) != null && Equals((CurveKey)obj); }

        public override int GetHashCode()
        {
            return this._position.GetHashCode() ^
                this._value.GetHashCode() ^
                this._tangentIn.GetHashCode() ^
                this._tangentOut.GetHashCode() ^
                this._continuity.GetHashCode();
        }
        #endregion
    }
}
